...
export function mergeNuxtConfig(existing: string, incoming: string): string {
  try {
...
export function mergeEnvExample(existing: string, incoming: string, moduleName: string): string {
